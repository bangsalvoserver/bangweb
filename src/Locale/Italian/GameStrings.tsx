...
export const GAME_STRINGS_ITALIAN: GameStringRegistry = {
    ...
    STATUS_DAMAGING: (player, card, damage) =>                              <>{player} prende {damage == 1 ? "un danno" : `${damage} danni`} per {card}</>,
    STATUS_DAMAGING_AS_BANG: (player, card, damage) =>                      <>{player} prende {damage == 1 ? "un danno" : `${damage} danni`} per {card} come Bang!</>,
    ...
    LOG_TAKEN_DAMAGE: (card, player, damage) =>                             <>{player} prende {damage == 1 ? "un danno" : `${damage} danni`} per {card}</>,
    LOG_TAKEN_DAMAGE_AS_BANG: (card, player, damage) =>                     <>{player} prende {damage == 1 ? "un danno" : `${damage} danni`} per {card} come Bang!</>,
