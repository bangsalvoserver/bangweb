...
export const GAME_STRINGS_ITALIAN: GameStringRegistry = {
    ...
    STATUS_BANG: (card, strength, damage) =>                                <>{card} ... Rispondi con {strength == 1 ? "Mancato" : `${strength} Mancato`} o Prendi {damage == 1 ? "danno" : `${damage} damage`}</>,
    STATUS_BANG_OTHER: (player, card) =>                                    <>{player} deve rispondere a {card}</>,
    STATUS_CARD_AS_BANG: (card, strength, damage) =>                        <>{card} come Bang! ... Rispondi con {strength == 1 ? "Mancato" : `${strength} Mancato`} o Prendi {damage == 1 ? "danno" : `${damage} damage`}</>,
