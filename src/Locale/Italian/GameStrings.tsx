...
export const GAME_STRINGS_ITALIAN: GameStringRegistry = {
    ...
    PROMPT_TARGET_GHOST: (card, ghost) =>                                   <>{ghost} è un fantasma, giocare {card} non avrebbe effetto. Continuare?</>,
    ...
    STATUS_GENERALSTORE: (player) =>                                        <>{player} ... Scegli una carta</>,
    STATUS_GENERALSTORE_OTHER: (player, card) =>                            <>{player} ... {card} deve scegliere una carta</>,
    ...
    STATUS_DESTROY: (card) =>                                               <>{card} per scartare {card} ... Puoi rispondere con Fuga</>,
    ...
    STATUS_STEAL: (card) =>                                                 <>{card} per rubare {card} ... Puoi rispondere con Fuga</>,
    ...
    STATUS_RICOCHET: (card) =>                                              <>{card} per scartare {card} ... Puoi rispondere con Mancato</>,
    ...
    STATUS_REQ_TUMBLEWEED_OTHER: (player, card, target_card, drawn_card) => <>{player} estrae {drawn_card} per {target_card} ... {4} può giocare {card}</>,
    ...
    STATUS_SWITCH_CARDS: (card, target_card) =>                             <>{card} per scambiare {card} con {target_card} ... Puoi rispondere con Fuga</>,
    ...
    ERROR_USER_CONTROLLING_PLAYER: () =>                                    <>Giocatore già in gioco</>,
    ...
    ERROR_INVALID_REJOIN_TARGET: () =>                                      <>Non puoi entrare in gioco come questo giocatore</>,
    ERROR_PLAYER_DOES_NOT_OWN_CARD: () =>                                   <>Carta non tua</>,
    ERROR_CARD_NOT_FOUND: () =>                                             <>Carta non trovata</>,
