...
export const GAME_STRINGS_ITALIAN: GameStringRegistry = {
    ...
    STATUS_CLASH_THE_STAMPEDE: (card) =>                                    <>{card} ... Decidi da chi ricevere una carta</>,
    STATUS_CLASH_THE_STAMPEDE_OTHER: (player, card) =>                      <>{card} ... {player} deve decidere da chi ricevere una carta</>,
