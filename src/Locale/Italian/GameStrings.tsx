...
export const GAME_STRINGS_ITALIAN: GameStringRegistry = {
    ...
    PROMPT_PASS_DISCARD: () =>                                              <>Devi scartare 1 carta. Continuare?</>,
    PROMPT_PASS_DISCARD_PLURAL: (ncards) =>                                 <>Devi scartare {ncards} carte. Continuare?</>,
    ...
    STATUS_DISCARD_PASS: () =>                                              <>Scarta una carta prima di passare il turno</>,
    STATUS_DISCARD_PASS_OTHER: (player) =>                                  <>{player} deve scartare una carta prima di passare il turno</>,
    STATUS_DISCARD_PASS_PLURAL: (ncards) =>                                 <>Scarta {ncards} carte prima di passare il turno</>,
    STATUS_DISCARD_PASS_PLURAL_OTHER: (player, ncards) =>                   <>{player} deve scartare {ncards} carte prima di passare il turno</>,
    STATUS_BANG: (card) =>                                                  <>{card} ... Rispondi con Mancato o Prendi danno</>,
    STATUS_BANG_STRONG: (card, strength) =>                                 <>{card} ... Rispondi con {strength} Mancato o prendi danno</>,
    STATUS_BANG_DAMAGE: (card, damage) =>                                   <>{card} ... Rispondi con Mancato o Prendi {damage} danni</>,
    STATUS_BANG_DAMAGE_STRONG: (card, strength, damage) =>                  <>{card} ... Rispondi con {strength} Mancato o prendi {damage} danni</>,
    STATUS_BANG_OTHER: (player, card) =>                                    <>{player} deve rispondere a {card}</>,
    STATUS_CARD_AS_BANG: (card) =>                                          <>{card} come Bang! ... Rispondi con Mancato o Prendi danno</>,
    STATUS_CARD_AS_BANG_STRONG: (card, strength) =>                         <>{card} come Bang! ... Rispondi con {strength} Mancato o prendi danno</>,
    STATUS_CARD_AS_BANG_DAMAGE: (card, damage) =>                           <>{card} come Bang! ... Rispondi con Mancato o Prendi {damage} danni</>,
    STATUS_CARD_AS_BANG_DMG_STRONG: (card, strength, damage) =>             <>{card} come Bang! ... Rispondi con {strength} Mancato o prendi {damage} danni</>,
    STATUS_CARD_AS_BANG_OTHER: (player, card) =>                            <>{player} deve rispondere a {card} come Bang!</>,
    STATUS_CARD_AS_GATLING: (card) =>                                       <>{card} come Gatling ... Rispondi con Mancato o Prendi danno</>,
    STATUS_CARD_AS_GATLING_OTHER: (player, card) =>                         <>{player} deve rispondere a {card} come Gatling</>,
    STATUS_INDIANS: (card) =>                                               <>{card} ... Rispondi con Bang o Prendi danno</>,
    STATUS_INDIANS_OTHER: (player, card) =>                                 <>{player} deve rispondere a {card}</>,
    STATUS_DUEL: (card) =>                                                  <>{card} ... Rispondi con Bang o Prendi danno</>,
    STATUS_DUEL_OTHER: (player, card) =>                                    <>{player} deve rispondere a {card}</>,
    STATUS_DESTROY: (card, target_card) =>                                  <>{card} per scartare {target_card} ... Puoi rispondere con Fuga</>,
    STATUS_DESTROY_FROM_HAND: (card) =>                                     <>{card} per scartare una carta dalla mano ... Puoi rispondere con Fuga</>,
    ...
    STATUS_STEAL: (card, target_card) =>                                    <>{card} per rubare {target_card} ... Puoi rispondere con Fuga</>,
    STATUS_STEAL_FROM_HAND: (card) =>                                       <>{card} per rubare una carta dalla mano ... Puoi rispondere con Fuga</>,
    ...
    STATUS_DEATH: () =>                                                     <>Devi giocare 1 birra per salvarti</>,
    STATUS_DEATH_PLURAL: (nbeers) =>                                        <>Devi giocare {nbeers} birre per salvarti</>,
    STATUS_DEATH_OTHER: (player) =>                                         <>{player} deve giocare 1 birra per salvarsi</>,
    STATUS_DEATH_OTHER_PLURAL: (player, card) =>                            <>{player} deve giocare {card} birre per salvarsi</>,
    ...
    STATUS_BANDIDOS: (card) =>                                              <>{card} ... Scarta due carte o Prendi danno</>,
    ...
    STATUS_ADD_CUBE: () =>                                                  <>Scegli su quale carta mettere un cubetto</>,
    STATUS_ADD_CUBE_OTHER: (player) =>                                      <>{player} deve scegliere su quale carta mettere un cubetto </>,
    STATUS_ADD_CUBE_PLURAL: (ncubes) =>                                     <>Scegli su quale carta mettere {ncubes} cubetti</>,
    STATUS_ADD_CUBE_PLURAL_OTHER: (player, ncubes) =>                       <>{player} deve scegliere su quale carta mettere {ncubes} cubetti </>,
    STATUS_ADD_CUBE_FOR: (card) =>                                          <>Scegli su quale carta mettere un cubetto, per {card}</>,
    STATUS_ADD_CUBE_FOR_OTHER: (player, card) =>                            <>{player} deve scegliere su quale carta mettere un cubetto, per {card}</>,
    STATUS_ADD_CUBE_PLURAL_FOR: (card, ncubes) =>                           <>Scegli su quale carta mettere {ncubes} cubetti, per {card}</>,
    STATUS_ADD_CUBE_PLURAL_FOR_OTHER: (player, card, ncubes) =>             <>{player} deve scegliere su quale carta mettere {ncubes} cubetti, per {card}</>,
    ...
    STATUS_RUST: (card) =>                                                  <>{card} ... Puoi rispondere con Fuga</>,
    STATUS_RUST_OTHER: (player, card) =>                                    <>{card} contro {player}</>,
    STATUS_RICOCHET: (card, target_card) =>                                 <>{card} per scartare {target_card} ... Puoi rispondere con Mancato</>,
    ...
    STATUS_DAMAGING: (player, card) =>                                      <>{player} prende un danno per {card}</>,
    STATUS_DAMAGING_PLURAL: (player, card, damage) =>                       <>{player} prende {damage} danni per {card}</>,
    STATUS_DAMAGING_AS_BANG: (player, card) =>                              <>{player} prende un danno per {card} come Bang!</>,
    STATUS_DAMAGING_AS_BANG_PLURAL: (player, card, damage) =>               <>{player} prende {damage} danni per {card} come Bang!</>,
    STATUS_DAMAGING_AS_GATLING: (player, card) =>                           <>{player} prende un danno per {card} come Gatling!</>,
    ...
    STATUS_SWITCH_CARDS: (card, target_card, chosen_card) =>                <>{card} per scambiare {target_card} con {chosen_card} ... Puoi rispondere con Fuga</>,
    ...
    STATUS_NEWIDENTITY: (card) =>                                           <>{card} ... Scegli con quale personaggio cambiare</>,
    STATUS_NEWIDENTITY_OTHER: (player, card) =>                             <>{card} ... {player} deve scegliere con quale personaggio cambiare</>,
    ...
    STATUS_MULTI_VULTURE_SAM: (card, player) =>                             <>{card} ... devi rubare una carta da {player}</>,
    STATUS_MULTI_VULTURE_SAM_OTHER: (card, player, target) =>               <>{card} ... {player} deve rubare una carta da {target}</>,
    ...
    STATUS_MAP: (card) =>                                                   <>{card} ... Scarta una delle carte o Conferma</>,
    STATUS_MAP_OTHER: (player, card) =>                                     <>{card} ... {player} deve scartare una carta o confermare</>,
    STATUS_MOST_WANTED: (card) =>                                           <>{card} ... Puoi rispondere con Fuga</>,
    ...
    LOG_DRAWN_A_CARD: (player) =>                                           <>{player} pesca una carta</>,
    LOG_DRAWN_N_CARDS: (player, ncards) =>                                  <>{player} pesca {ncards} carte</>,
    LOG_DRAWN_CARD_FOR: (player, target_card, card) =>                      <>{player} pesca {target_card} per {card}</>,
    LOG_DRAWN_A_CARD_FOR: (player, card) =>                                 <>{player} pesca una carta per {card}</>,
    LOG_DRAWN_N_CARDS_FOR: (player, ncards, card) =>                        <>{player} pesca {ncards} carte per {card}</>,
    ...
    LOG_TAKEN_DAMAGE: (card, player) =>                                     <>{player} prende 1 danno per {card}</>,
    LOG_TAKEN_DAMAGE_PLURAL: (card, player, damage) =>                      <>{player} prende {damage} danni per {card}</>,
    LOG_TAKEN_DAMAGE_AS_BANG: (card, player) =>                             <>{player} prende un danno per {card} come Bang!</>,
    LOG_TAKEN_DAMAGE_AS_BANG_PLURAL: (card, player, damage) =>              <>{player} prende {damage} danni per {card} come Bang!</>,
    LOG_TAKEN_DAMAGE_AS_GATLING: (card, player) =>                          <>{player} prende un danno per {card} come Gatling</>,
    LOG_HEALED: (player) =>                                                 <>{player} si cura di 1 punto vita</>,
    LOG_HEALED_PLURAL: (player, amount) =>                                  <>{player} si cura di {amount} punti vita</>,
    ...
    LOG_MOVED_CUBE: (player, origin, target) =>                             <>{player} sposta un cubo da {origin} a {target}</>,
    LOG_MOVED_CUBES: (player, origin, target, ncubes) =>                    <>{player} sposta {ncubes} cubi da {origin} a {target}</>,
    LOG_MOVED_CUBE_FROM: (player, target, card, target_card) =>             <>{player} sposta un cubo da {card} di {target} a {target_card}</>,
    LOG_MOVED_CUBES_FROM: (player, target, card, target_card, ncubes) =>    <>{player} sposta {ncubes} cubi da {card} di {target} a {target_card}</>,
    LOG_PAID_CUBE: (player, card) =>                                        <>{player} paga un cubo da {card}</>,
    LOG_PAID_CUBES: (player, card, ncubes) =>                               <>{player} paga {ncubes} cubi da {card}</>,
    LOG_DROP_CUBE: (player, card) =>                                        <>{player} scarta un cubo da {card}</>,
    LOG_DROP_CUBES: (player, card, ncubes) =>                               <>{player} scarta {ncubes} cubi da {card}</>,
    LOG_ADD_CUBE: (player, card) =>                                         <>{player} aggiunge un cubo su {card}</>,
    LOG_ADD_CUBES: (player, card, ncubes) =>                                <>{player} aggiunge {ncubes} cubi su {card}</>,
