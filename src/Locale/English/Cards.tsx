...
TERMIT: {
    name: 'Termit',
    description: <>If General Store is played, one extra card is revealed and he takes 2. Starts with +1 card if last/next-to-last. Hand limit is +1 if HP les than 3.</>
},
SITEJ: {
    name: 'Šitej',
