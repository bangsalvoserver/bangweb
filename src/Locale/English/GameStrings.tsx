...
export const GAME_STRINGS_ENGLISH: GameStringRegistry = {
    ...
    LOG_DECLARED_RED: (arg0, arg1) =>                                           <>{arg0} declares Red per {arg1}</>,
    LOG_DECLARED_BLACK: (arg0, arg1) =>                                         <>{arg0} declares Black per {arg1}</>,
    LOG_DECLARED_CLUBS: (arg0, arg1) =>                                         <>{arg0} declares Clubs per {arg1}</>,
    LOG_DECLARED_DIAMONDS: (arg0, arg1) =>                                      <>{arg0} declares Diamonds per {arg1}</>,
    LOG_DECLARED_HEARTS: (arg0, arg1) =>                                        <>{arg0} declares Hearts per {arg1}</>,
    LOG_DECLARED_SPADES: (arg0, arg1) =>                                        <>{arg0} declares Spades per {arg1}</>,
