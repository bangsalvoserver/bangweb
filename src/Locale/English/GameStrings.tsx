...
export const GAME_STRINGS_ENGLISH: GameStringRegistry = {
    ...
    PROMPT_BANDIDOS_SUICIDE: (card) =>                                          <>Playing {card} will lead to suicide. Continue?</>,
    ...
    STATUS_CLASH_THE_STAMPEDE: (card) =>                                        <>{card} ... Decide who to get a card from</>,
    STATUS_CLASH_THE_STAMPEDE_OTHER: (player, card) =>                          <>{card} ... {player} must decide who to get a card from</>,
    ...
    STATUS_MAP: (card) =>                                                       <>{card} ... Choose one of the cards and discard the other or Confirm to choose both</>,
