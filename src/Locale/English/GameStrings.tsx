...
export const GAME_STRINGS_ENGLISH: GameStringRegistry = {
    ...
    PROMPT_PASS_DISCARD: () =>                                                  <>You must discard 1 card. Continue?</>,
    PROMPT_PASS_DISCARD_PLURAL: (ncards) =>                                     <>You must discard {ncards} cards. Continue?</>,
    ...
    STATUS_DISCARD_PASS_OTHER: (player) =>                                      <>{player} must discard a card before passing the turn</>,
    STATUS_DISCARD_PASS_PLURAL: (ncards) =>                                     <>Discard {ncards} cards before passing the turn</>,
    STATUS_DISCARD_PASS_PLURAL_OTHER: (player, ncards) =>                       <>{player} must discard {ncards} cards before passing the turn</>,
    STATUS_BANG: (card) =>                                                      <>{card} ... Respond with Missed or Take damage</>,
    STATUS_BANG_STRONG: (card, ncards) =>                                       <>{card} ... Respond with {ncards} Missed or Take damage</>,
    STATUS_BANG_DAMAGE: (card, damage) =>                                       <>{card} ... Respond with Missed or Take {damage} damage</>,
    STATUS_BANG_DAMAGE_STRONG: (card, strength, damage) =>                      <>{card} ... Respond with {strength} Missed or Take {damage} damage</>,
    STATUS_BANG_OTHER: (player, card) =>                                        <>{player} must respond to {card}</>,
    STATUS_CARD_AS_BANG: (card) =>                                              <>{card} as Bang! ... Respond with Missed or Take damage</>,
    STATUS_CARD_AS_BANG_STRONG: (card, strength) =>                             <>{card} as Bang! ... Respond with {strength} Missed or Take damage</>,
    STATUS_CARD_AS_BANG_DAMAGE: (card, damage) =>                               <>{card} as Bang! ... Respond with Missed or Take {damage} damage</>,
    STATUS_CARD_AS_BANG_DMG_STRONG: (card, strength, damage) =>                 <>{card} as Bang! ... Respond with {strength} Missed or Take {damage} damage</>,
    STATUS_CARD_AS_BANG_OTHER: (player, card) =>                                <>{player} must respond to {card} as Bang!</>,
    STATUS_CARD_AS_GATLING: (card) =>                                           <>{card} as Gatling ... Respond with Missed or Take damage</>,
    STATUS_CARD_AS_GATLING_OTHER: (player, card) =>                             <>{player} must respond to {card} as Gatling</>,
    STATUS_INDIANS: (card) =>                                                   <>{card} ... Respond with Bang or Take damage</>,
    STATUS_INDIANS_OTHER: (player, card) =>                                     <>{player} must respond to {card}</>,
    STATUS_DUEL: (card) =>                                                      <>{card} ... Respond with Bang or Take damage</>,
    STATUS_DUEL_OTHER: (player, card) =>                                        <>{player} must respond to {card}</>,
    STATUS_DESTROY: (card, target_card) =>                                      <>{card} to discard {target_card} ... You can respond with Escape</>,
    STATUS_DESTROY_FROM_HAND: (card) =>                                         <>{card} to discard a card from you hand ... You can respond with Escape</>,
    ...
    STATUS_STEAL: (card, target_card) =>                                        <>{card} to steal {target_card} ... You can respond with Escape</>,
    STATUS_STEAL_FROM_HAND: (card) =>                                           <>{card} to steal a card from your hand ... You can respond with Escape</>,
    ...
    STATUS_DEATH: () =>                                                         <>You must play beer to save yourself</>,
    STATUS_DEATH_PLURAL: (nbeers) =>                                            <>You must play {nbeers} beers to save yourself</>,
    STATUS_DEATH_OTHER: (arg0) =>                                               <>{arg0} must play beer to escape death</>,
    STATUS_DEATH_OTHER_PLURAL: (arg0, nbeers) =>                                <>{arg0} must play {nbeers} beers to escape death</>,
    ...
    STATUS_BANDIDOS: (player) =>                                                <>{player} ... Discard two cards or Take damage</>,
    ...
    STATUS_ADD_CUBE: (arg0) =>                                                  <>Choose which card to put a cube onto</>,
    STATUS_ADD_CUBE_OTHER: (arg0) =>                                            <>{arg0} must choose which card to put a cube onto</>,
    STATUS_ADD_CUBE_PLURAL: (ncubes) =>                                         <>Choose which card to put {ncubes} cubes onto</>,
    STATUS_ADD_CUBE_PLURAL_OTHER: (arg0, arg1) =>                               <>{arg0} must choose which card to put {arg1} cubes onto</>,
    STATUS_ADD_CUBE_FOR: (arg0) =>                                              <>Choose which card to put a cube onto, for {arg0}</>,
    STATUS_ADD_CUBE_FOR_OTHER: (arg0, arg1) =>                                  <>{arg0} must choose which card to put a cube onto, for {arg1}</>,
    STATUS_ADD_CUBE_PLURAL_FOR: (arg0, arg1) =>                                 <>Choose which card to put {arg1} cubes onto, for {arg0}</>,
    STATUS_ADD_CUBE_PLURAL_FOR_OTHER: (arg0, arg1, arg2) =>                     <>{arg0} must choose which card to put {arg2} cubes onto, for {arg1}</>,
    ...
    STATUS_RUST: (arg0) =>                                                      <>{arg0} ... You can respond with Escape</>,
    STATUS_RUST_OTHER: (arg0, arg1) =>                                          <>{arg1} against {arg0}</>,
    STATUS_RICOCHET: (arg0, arg1) =>                                            <>{arg0} to discard {arg1} ... You can respond with Missed</>,
    ...
    STATUS_DAMAGING: (arg0, arg1) =>                                            <>{arg0} takes 1 damage for {arg1}</>,
    STATUS_DAMAGING_PLURAL: (arg0, arg1, arg2) =>                               <>{arg0} takes {arg2} damage for {arg1}</>,
    STATUS_DAMAGING_AS_BANG: (arg0, arg1) =>                                    <>{arg0} takes 1 damage for {arg1} as Bang!</>,
    STATUS_DAMAGING_AS_BANG_PLURAL: (arg0, arg1, arg2) =>                       <>{arg0} takes {arg2} damage for {arg1} as Bang!</>,
    STATUS_DAMAGING_AS_GATLING: (arg0, arg1) =>                                 <>{arg0} takes 1 damage for {arg1} as Gatling!</>,
    ...
    STATUS_SWITCH_CARDS: (arg0, arg1, arg2) =>                                  <>{arg0} to switch {arg1} with {arg2} ... You can respond with Escape</>,
    ...
    STATUS_NEWIDENTITY: (arg0) =>                                               <>{arg0} ... Choose which character to switch to</>,
    STATUS_NEWIDENTITY_OTHER: (arg0, arg1) =>                                   <>{arg1} ... {arg0} must choose which character to switch to</>,
    ...
    STATUS_MULTI_VULTURE_SAM: (arg0, arg1) =>                                   <>{arg0} ... you must steal a card from {arg1}</>,
    STATUS_MULTI_VULTURE_SAM_OTHER: (arg0, arg1, arg2) =>                       <>{arg0} ... {arg1} must steal a card from {arg2}</>,
    ...
    STATUS_MAP: (arg0) =>                                                       <>{arg0} ... Discard one of the cards or Confirm</>,
    STATUS_MAP_OTHER: (arg0, arg1) =>                                           <>{arg1} ... {arg0} must discard on of the cards or confirm</>,
    STATUS_MOST_WANTED: (arg0) =>                                               <>{arg0} ... You can respond with Escape</>,
    STATUS_MOST_WANTED_OTHER: (arg0, arg1) =>                                   <>{arg1} against {arg0}</>,
    STATUS_TRAIN_ROBBERY: (arg0) =>                                             <>{arg0} ... choose a card</>,
    STATUS_TRAIN_ROBBERY_OTHER: (arg0, arg1) =>                                 <>{arg1} ... {arg0} must choose a card</>,
    STATUS_TRAIN_ROBBERY_CHOOSE: (arg0, arg1) =>                                <>{arg0} ... Choose between discarding {arg1} or receiving a Bang</>,
    ...
    ERROR_TARGET_NOT_DEAD: () =>                                                <>You can't target a live player</>,
    ERROR_TARGET_DEAD: () =>                                                    <>You can't target a dead player</>,
    ERROR_TARGET_SHERIFF: () =>                                                 <>You can't target the sheriff</>,
    ERROR_TARGET_NOT_SELF: () =>                                                <>You can only target yourself</>,
    ERROR_TARGET_SELF: () =>                                                    <>You can't target yourself</>,
    ERROR_TARGET_ORIGIN: () =>                                                  <>You can't target your attacker</>,
    ERROR_TARGET_EMPTY_HAND: () =>                                              <>You can't target a player with an empty hand</>,
    ERROR_TARGET_EMPTY_TABLE: () =>                                             <>You can't target a player with no cards in play</>,
    ERROR_TARGET_EMPTY_CUBES: () =>                                             <>You can't target a player with no cubes</>,
    ...
    LOG_DRAWN_A_CARD: (arg0) =>                                                 <>{arg0} draws a card</>,
    LOG_DRAWN_N_CARDS: (arg0, arg1) =>                                          <>{arg0} draws {arg1} cards</>,
    LOG_DRAWN_CARD_FOR: (arg0, arg1, arg2) =>                                   <>{arg0} draws {arg1} for {arg2}</>,
    LOG_DRAWN_A_CARD_FOR: (arg0, arg1) =>                                       <>{arg0} draws a card for {arg1}</>,
    LOG_DRAWN_N_CARDS_FOR: (arg0, arg1, arg2) =>                                <>{arg0} draws {arg1} cards for {arg2}</>,
    ...
    LOG_TAKEN_DAMAGE: (arg0, arg1) =>                                           <>{arg1} takes 1 damage for {arg0}</>,
    LOG_TAKEN_DAMAGE_PLURAL: (arg0, arg1, arg2) =>                              <>{arg1} takes {arg2} damage for {arg0}</>,
    LOG_TAKEN_DAMAGE_AS_BANG: (arg0, arg1) =>                                   <>{arg1} takes 1 damage for {arg0} as Bang!</>,
    LOG_TAKEN_DAMAGE_AS_BANG_PLURAL: (arg0, arg1, arg2) =>                      <>{arg1} takes {arg2} damage for {arg0} as Bang!</>,
    LOG_TAKEN_DAMAGE_AS_GATLING: (arg0, arg1) =>                                <>{arg1} takes 1 damage for {arg0} as Gatling</>,
    LOG_HEALED: (arg0) =>                                                       <>{arg0} heals for 1 life point</>,
    LOG_HEALED_PLURAL: (arg0, arg1) =>                                          <>{arg0} heals for {arg1} life points</>,
    ...
    LOG_MOVED_CUBE: (player, origin, target) =>                                 <>{player} moves a cube from {origin} to {target}</>,
    LOG_MOVED_CUBES: (player, origin, target, ncubes) =>                        <>{player} moves {ncubes} cubes from {origin} to {target}</>,
    LOG_MOVED_CUBE_FROM: (player, target, card, target_card) =>                 <>{player} moves a cube from {target}'s {card} to {target_card}</>,
    LOG_MOVED_CUBES_FROM: (player, target, card, target_card, ncubes) =>        <>{player} moves {ncubes} cubes from {target}'s {card} to {target_card}</>,
    LOG_PAID_CUBE: (player, card) =>                                            <>{player} pays a cube from {card}</>,
    LOG_PAID_CUBES: (player, card, ncubes) =>                                   <>{player} pays {ncubes} cubes from {card}</>,
    LOG_DROP_CUBE: (player, card) =>                                            <>{player} drops a cube from {card}</>,
    LOG_DROP_CUBES: (player, card, ncubes) =>                                   <>{player} drops {ncubes} cubes from {card}</>,
    LOG_ADD_CUBE: (player, card) =>                                             <>{player} adds a cube on {card}</>,
    LOG_ADD_CUBES: (player, card, ncubes) =>                                    <>{player} adds {ncubes} cubes on {card}</>,
    ...
    LOG_RECEIVED_N_BANGS_FOR: (arg0, arg1, arg2) =>                             <>{arg0} receives {arg2} Bang! for {arg1}</>,
    LOG_MANDATORY_CARD: (arg0, arg1) =>                                         <>{arg0} must play {arg1} in phase two</>,
    LOG_DECLARED_RED: (arg0, arg1) =>                                           <>{arg0} declares Red for {arg1}</>,
    LOG_DECLARED_BLACK: (arg0, arg1) =>                                         <>{arg0} declares Black for {arg1}</>,
    LOG_DECLARED_CLUBS: (arg0, arg1) =>                                         <>{arg0} declares Clubs for {arg1}</>,
    LOG_DECLARED_DIAMONDS: (arg0, arg1) =>                                      <>{arg0} declares Diamonds for {arg1}</>,
    LOG_DECLARED_HEARTS: (arg0, arg1) =>                                        <>{arg0} declares Hearts for {arg1}</>,
    LOG_DECLARED_SPADES: (arg0, arg1) =>                                        <>{arg0} declares Spades for {arg1}</>,
