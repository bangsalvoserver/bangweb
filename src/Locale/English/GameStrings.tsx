...
export const GAME_STRINGS_ENGLISH: GameStringRegistry = {
    ...
    STATUS_BANG: (card, strength, damage) =>                                    <>{card} ... Respond with {strength == 1 ? "Missed" : `${strength} Missed`} or Take {damage == 1 ? "damage" : `${damage} damage`}</>,
    STATUS_BANG_OTHER: (player, card) =>                                        <>{player} must respond to {card}</>,
    STATUS_CARD_AS_BANG: (card, strength, damage) =>                            <>{card} as Bang! ... Respond {strength == 1 ? "Missed" : `${strength} Missed`} or Take {damage == 1 ? "damage" : `${damage} damage`}</>,
