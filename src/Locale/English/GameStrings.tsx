...
export const GAME_STRINGS_ENGLISH: GameStringRegistry = {
    ...
    STATUS_DAMAGING: (player, card, damage) =>                                  <>{player} takes {damage} damage for {card}</>,
    STATUS_DAMAGING_AS_BANG: (player, card, damage) =>                          <>{player} takes {damage} damage for {card} as Bang!</>,
    ...
    LOG_TAKEN_DAMAGE: (card, player, damage) =>                                 <>{player} takes {damage} damage for {card}</>,
    LOG_TAKEN_DAMAGE_AS_BANG: (card, player, damage) =>                         <>{player} takes {damage} damage for {card} as Bang!</>,
